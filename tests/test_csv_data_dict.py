...
def test_csv_data_dict():
    assert get_csv_data_dict("../data/test_csv_1.csv") == [
        {
            "id": "650703",
            "state": "EXECUTED",
...
def test_csv_data_dict_1():
    assert get_csv_data_dict("../data/test_csv_2.csv") == [
        {
            "id": "1962667",
            "state": "EXECUTED",
...
def test_csv_data_dict_2():
    assert get_csv_data_dict("../data/test_csv.csv") == [{}]
